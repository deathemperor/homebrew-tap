class ClaudeSwap < Formula
  ...
  desc "Multi-account switcher for Claude Code (the engine behind Limitless)"
  homepage "https://github.com/deathemperor/claude-swap"
  url "https://files.pythonhosted.org/packages/94/bd/b993db9038aad64fd7d3abc9105580b842bb09a2f188037c57922b06ffb3/claude_swap-0.25.0.tar.gz"
  sha256 "e665dbd7249f1211a5bc6df384c10965d78fd950b2cde305e1af93a73c8648d0"
  license "MIT"
  ...
  test do
    assert_match "cswap", shell_output("#{bin}/cswap --help")
  end
end
